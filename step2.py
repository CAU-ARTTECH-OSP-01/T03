...
photo = PhotoImage(file="달걀_moza.png")
...
def ingredient1():
    ibtn = Button(window, text="토마토를 어떻게 요리하시겠습니까?", command=press2)
...
def ingredient3():
    ibtn = Button(window, text="꿀를 어떻게 요리하시겠습니까?", command=press2)
