...
def next_level_pesco():
    ...
    def press_next():
        ...
        btn_seafood_mille_feuille_nabe= Button(window, width=200, height=200, image=photo_seafood_mille_feuille_nabe, command=seafood_mille_feuille_nabe)
        btn_seafood_mille_feuille_nabe.pack()

        photo_fishcake_burger = PhotoImage(file="mosaic/고등어조림01.png")  # 찜닭
        btn_fishcake_burger = Button(window, width=200, height=200, image=photo_fishcake_burger, command=fishcake_burger)
